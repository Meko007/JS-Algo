...
// console.log(searchArray(bigArray, [9, 20]));
// console.log(searchArray(bigArray, [1, 12]));
// console.log(searchArray(bigArray, [7, 2]));
// console.log(searchArray([1, 2, 3, 4, 6], [1, 12]));
// console.log(searchArray([[1, 2], [3, 4], 6], [1, 12]));
// console.log(searchArray(bigArray, [2, 3, 7]));
// console.log(searchArray(bigArray, 3));
